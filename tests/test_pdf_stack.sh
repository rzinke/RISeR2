...
A1name="tmp/age1.txt"
riser-make-pdf -d gaussian -s 4.0 0.4 -dx 0.01 \
    --name "age" --variable-type "age" --unit "ky" \
    -o $A1name

A1prior_name="tmp/age1_prior.txt"
riser-make-pdf -d gaussian -s 4.1 0.7 -dx 0.01 \
    --name "age prior" --variable-type "age" --unit "ky" \
    -o $A1prior_name

A2name="tmp/age2.txt"
riser-make-pdf -d gaussian -s 6.3 0.6 -dx 0.01 \
    --name "age" --variable-type "age" --unit "ky" \
    -o $A2name

A2prior_name="tmp/age2_prior.txt"
riser-make-pdf -d gaussian -s 6.1 0.8 -dx 0.01 \
    --name "age prior" --variable-type "age" --unit "ky" \
    -o $A2prior_name
...
A4name="tmp/age4.txt"
riser-make-pdf -d gaussian -s 9.0 0.7 -dx 0.01 \
    --name "age" --variable-type "age" --unit "ky" \
    -o $A4name
...
riser-view-pdf-stack $config_file
