...
from riser.variable_operations import merge_variables
...
def main():
    ...
    # Compute merged PDF
    merged_pdf = merge_variables(pdfs, verbose=inps.verbose)

    # Save to file
    readers.save_pdf(inps.outname, merged_pdf, verbose=inps.verbose)
