...
#################### ARGUMENT PARSER ####################
description = (
    "Compute the incremental slip rates for a series of dated markers by "
    "computing the deltas between adjacent pairs of displacements and ages, "
    "and dividing displacement by age, using the analytical formulation."
)
