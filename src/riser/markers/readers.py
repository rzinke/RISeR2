...
def initialize_marker_from_files(age_fname:str, displacement_fname:str,
    ...
    marker = DatedMarker(age, displacement)
...
def read_markers_from_config(fname:str, verbose=False) -> dict:
    ...
    Optionally, age and displacement metadata can be specified, though any
    metadata encoded in the file on disk will take precedence over the
    user specification, per the set_metadata_priority function.
